...
<head>
  ...
  <style id="FLAVORFUL_GLOBAL_STYLE">
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .card { background: #fff; border: 1px solid #eee; border-radius: 8px; width: 300px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.05); overflow: hidden; text-align: center; transition: transform 0.3s; }
    .card:hover { transform: translateY(-5px); box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1); }

    .card img { width: 100%; height: 200px; object-fit: cover; }
    .card-content { padding: 20px; }
    .card-content h4 { font-size: 24px; font-weight: 700; margin-bottom: 10px; }
    .card-content a { color: #f59e0b; text-decoration: none; font-weight: 600; }
...
<body>
  ...
  <section class="hero">
    <div class="hero-text">
      ...
      <p>Follow us for more updates on deals, communication, deliveries and to see our schedule.</p>
    </div>
    <img src="https://placehold.co/400x300/f59e0b/ffffff?text=Socials" alt="Socials" onerror="this.onerror=null;this.src='https://placehold.co/400x300/f59e0b/ffffff?text=Socials';">
  </section>
  ...
  <section class="recent">
    ...
    <div class="card-container">
      <div class="card">
        <img src="https://placehold.co/300x200/3b5998/ffffff?text=Facebook" alt="Facebook" onerror="this.onerror=null;this.src='https://placehold.co/300x200/3b5998/ffffff?text=Facebook';">
      ...
      <div class="card">
        <img src="https://placehold.co/300x200/1da1f2/ffffff?text=Twitter" alt="Twitter" onerror="this.onerror=null;this.src='https://placehold.co/300x200/1da1f2/ffffff?text=Twitter';">
        <div class="card-content">
          <h4>Twitter (X)</h4>
          <a href="https://twitter.com/flavorful" target="_blank">@FlavorfulGD</a>
        </div>
      </div>

      <div class="card">
        <img src="https://placehold.co/300x200/e1306c/ffffff?text=Instagram" alt="Instagram" onerror="this.onerror=null;this.src='https://placehold.co/300x200/e1306c/ffffff?text=Instagram';">
        <div class="card-content">
          <h4>Instagram</h4>
          <a href="https://instagram.com/flavorful_gd" target="_blank">@Flavorful_GD</a>
        </div>
      </div>
    </div>
  </section>
