...
// -------------------------------------------
$host = "sql300.infinityfree.com"; // Your InfinityFree SQL hostname
$username = "noels";       // Replace with your db username
$password = "noelbest2025";       // Replace with your db password
$dbname = "flavorful";          // Replace with your db name

// -------------------------------------------
// Connect to MySQL
// -------------------------------------------
$conn = new mysqli($sql300.infinityfree.com, $noels, $noelbest2025, $flavorful);
...
// -------------------------------------------
// SQL schema (tables + products insert)
// -------------------------------------------
$sql = "
...
if ($conn->multi_query($sql)) {
    echo "✅ Database tables created and sample products inserted successfully!";
} else {
