...
CREATE TABLE IF NOT EXISTS users (
    ...
    initials VARCHAR(2), -- Stored initials for profile icon
...
-- Order Items Table (Details of what was in the order)
...
('Blue Raspberry', 'Blue Raspberry', 0.50, 'single', 'Artificially flavored blue raspberry pennacool'),
('Packet', 'Assorted', 5.00, 'packet', 'A convenient packet containing 12 assorted pennacools (Cherry, Orange, Grape).');