...
// NOTE: This page does not require a database connection.
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <header>
    ...
    <nav>
      ...
      <a href="workers.php" style="background-color: #f0f0f0;">Workers</a>
  ...
  <section class="workers-section">
    ...
    <div class="card-container">
      ...
      <!-- Manager -->
      <div class="card">
        <img src="https://placehold.co/150x150/f59e0b/ffffff?text=Manager" alt="Manager">
        <h4>The Manager</h4>
      ...
      <!-- Noel -->
      <div class="card">
        <img src="https://placehold.co/150x150/f59e0b/ffffff?text=Noel" alt="Noel">
        <h4>Noel</h4>
      ...
      <!-- Allana -->
      <div class="card">
        <img src="https://placehold.co/150x150/f59e0b/ffffff?text=Allana" alt="Allana">
        <h4>Allana</h4>
        <span>Mixer</span>
      ...
      <!-- Ezekiel -->
      <div class="card">
        <img src="https://placehold.co/150x150/f59e0b/ffffff?text=Ezekiel" alt="Ezekiel">
        <h4>Ezekiel</h4>
